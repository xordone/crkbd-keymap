...
const char* PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 LAYOUT_split_3x6_3(
  ...
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                          KC_LALT, KC_TRNS, KC_TRNS,   KC_TRNS,  MO(3), KC_DEL
                                      //`--------------------------'  `--------------------------'
  ),
  ...
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                      XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, TD(TAP1),
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
...
#define LAYOUT_split_3x6_3( \
  ...
  { \
    ...
    { L10, L11, L12, L13, L14, L15 }, \
    { L20, L21, L22, L23, L24, L25 }, \
    { 00, 00, 00, L30, L31, L32 }, \
    { R05, R04, R03, R02, R01, R00 }, \
    { R15, R14, R13, R12, R11, R10 }, \
    { R25, R24, R23, R22, R21, R20 }, \
    { 00, 00, 00, R32, R31, R30 } \
  }
...
LAYOUT_split_3x6_3_1(
  //,-----------------------------------------------------.                    ,-----------------------------------------------------.
       40,        40,    41,     42,       43,        43,                            46,    46,      47,     48,     49,        49,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
       30,        30,    31,     32,       33,        33,                            36,    36,      37,     38,     39,        39,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
       20,        20,    21,     22,       23,        23,                            26,    26,      27,     28,     29,        29,
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                          34,       34,     34,           35,      35,    35
                                      //`--------------------------'  `--------------------------'
